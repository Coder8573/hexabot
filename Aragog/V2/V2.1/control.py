...
class control():
    ...
    def walk(self, dir, speed, gait=1, origin_point=(180, 0, -80)):
        ...
        if self.current_gait == 0:  # Monogait
            ...
            ground_touching_prozentage = 50
            self.path_point, self.walk_progress = walk.gen_next_path_point(stepsize, self.walk_progress, ground_touching_prozentage)
            self.point[0] = walk.gen_next_path_point(stepsize, self.walk_progress, ground_touching_prozentage)[0]
            self.point[1] = walk.gen_next_path_point(stepsize, self.walk_progress, ground_touching_prozentage)[0]
            self.point[2] = walk.gen_next_path_point(stepsize, self.walk_progress, ground_touching_prozentage)[0]
            self.point[3] = walk.gen_next_path_point(stepsize, self.walk_progress, ground_touching_prozentage)[0]
            self.point[4] = walk.gen_next_path_point(stepsize, self.walk_progress, ground_touching_prozentage)[0]
            self.point[5] = walk.gen_next_path_point(stepsize, self.walk_progress, ground_touching_prozentage)[0]
        ...
        if self.current_gait == 1:  # Trigait
            ...
            for i in range(0, 5000):
                self.walk_progress = walk.gen_next_path_point(1, stepsize, self.walk_progress, ground_touching_prozentage, origin_point, dir)[1]
                self.point[0] = walk.gen_next_path_point(1, stepsize, self.walk_progress, ground_touching_prozentage, origin_point, dir)[0]
            ...
            ground_touching_prozentage = 84
            self.path_point, self.walk_progress = walk.gen_next_path_point(stepsize, self.walk_progress,ground_touching_prozentage)
            self.point[0] = walk.gen_next_path_point(stepsize, self.walk_progress, ground_touching_prozentage)[0]
            self.point[1] = walk.gen_next_path_point(stepsize, self.walk_progress+(100/6)*1, ground_touching_prozentage)[0]
            self.point[2] = walk.gen_next_path_point(stepsize, self.walk_progress+(100/6)*2, ground_touching_prozentage)[0]
            self.point[3] = walk.gen_next_path_point(stepsize, self.walk_progress+(100/6)*3, ground_touching_prozentage)[0]
            self.point[4] = walk.gen_next_path_point(stepsize, self.walk_progress+(100/6)*4, ground_touching_prozentage)[0]
            self.point[5] = walk.gen_next_path_point(stepsize, self.walk_progress+(100/6)*5, ground_touching_prozentage)[0]
            self.pre_move_local_coord(1, walk.path_point_to_local_coord(1, self.point[0], orgin_point, dir))
            self.pre_move_local_coord(2, walk.path_point_to_local_coord(2, self.point[1], orgin_point, dir))
            self.pre_move_local_coord(3, walk.path_point_to_local_coord(3, self.point[2], orgin_point, dir))
            self.pre_move_local_coord(4, walk.path_point_to_local_coord(4, self.point[3], orgin_point, dir))
            ...
            stepsize = (speed - 0.20) * 0.8 + 0.05
            ground_touching_prozentage = 53
            self.path_point, self.walk_progress = walk.gen_next_path_point(stepsize, self.walk_progress,ground_touching_prozentage)
            self.point[0] = walk.gen_next_path_point(stepsize, self.walk_progress, ground_touching_prozentage)[0]
            self.point[1] = walk.gen_next_path_point(stepsize, self.walk_progress+(100/6)*4, ground_touching_prozentage)[0]
            self.point[2] = walk.gen_next_path_point(stepsize, self.walk_progress+(100/6)*2, ground_touching_prozentage)[0]
            self.point[3] = walk.gen_next_path_point(stepsize, self.walk_progress+(100/6)*5, ground_touching_prozentage)[0]
            self.point[4] = walk.gen_next_path_point(stepsize, self.walk_progress+(100/6), ground_touching_prozentage)[0]
            self.point[5] = walk.gen_next_path_point(stepsize, self.walk_progress+(100/6)*3, ground_touching_prozentage)[0]
            self.pre_move_local_coord(1, walk.path_point_to_local_coord(1, self.point[0], orgin_point, dir))
            self.pre_move_local_coord(2, walk.path_point_to_local_coord(2, self.point[1], orgin_point, dir))
            self.pre_move_local_coord(3, walk.path_point_to_local_coord(3, self.point[2], orgin_point, dir))
            self.pre_move_local_coord(4, walk.path_point_to_local_coord(4, self.point[3], orgin_point, dir))
            ...
            stepsize = (speed - 0.20) * 0.8 + 0.05
            ground_touching_prozentage = 35
            self.path_point, self.walk_progress = walk.gen_next_path_point(stepsize, self.walk_progress,ground_touching_prozentage)
            self.point[0] = walk.gen_next_path_point(stepsize, self.walk_progress, ground_touching_prozentage)[0]
            self.point[1] = walk.gen_next_path_point(stepsize, self.walk_progress+(100/3), ground_touching_prozentage)[0]
            self.point[2] = walk.gen_next_path_point(stepsize, self.walk_progress+(100/3)*2, ground_touching_prozentage)[0]
            self.point[3] = walk.gen_next_path_point(stepsize, self.walk_progress, ground_touching_prozentage)[0]
            self.point[4] = walk.gen_next_path_point(stepsize, self.walk_progress+(100/3), ground_touching_prozentage)[0]
            self.point[5] = walk.gen_next_path_point(stepsize, self.walk_progress+(100/3)*2, ground_touching_prozentage)[0]
            self.pre_move_local_coord(1, walk.path_point_to_local_coord(1, self.point[0], orgin_point, dir))
            self.pre_move_local_coord(2, walk.path_point_to_local_coord(2, self.point[1], orgin_point, dir))
            self.pre_move_local_coord(3, walk.path_point_to_local_coord(3, self.point[2], orgin_point, dir))
            self.pre_move_local_coord(4, walk.path_point_to_local_coord(4, self.point[3], orgin_point, dir))
